...
<div class="container about-section">
      <div>
        <h1>Devolução de animais</h1>
         ...
         <label>Ao clicar para confirmar esse retorno, fica declarado que toda a responsabilidade sobre o animal está </br>sendo passada novamente à instituição (Canil)
        ...
        <div class="column cards-position-langs">
          <div>
            <form method="POST" action="./devolverAdotado.php?id=<?php echo $selected_adoption_id; ?>&animal=<?php echo $selected_animal_id; ?>">
              <p> <input class="button" type="submit" name="devolucao" value="Sim" />  </p>
            </form>
          </div>
        </div>
        <div class="column cards-position-langs">
          <div>
            <p> <a href="adocao.php"><button class="button">Não</button></a></p>
          </div><br/>
        </div>
    </div>
</div>
