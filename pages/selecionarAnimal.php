                ...
                <div class="col-lg-12">
                    <div class="table-responsive"> 
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link" href="selecionarAnimal.php?page=0">Anterior</a></li>
                                <?php for($i=0;$i<$num_total;$i++){
                                    $style = "";
                                    if($pagina_atual == $i)
                                        $style = "class=\"active\"";
                                ?>
                                <li class="active"> <a class="page-link" href="selecionarAnimal.php?page=<?php echo ($i * $itens_por_pagina); ?>"><?php echo ($i + 1); ?></a> </li>
                                <?php }?>
                                <li class="page-item"><a class="page-link" href="selecionarAnimal.php?page=<?php echo $num_total-1; ?>">Próxima</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
