...
<div class="container">
    <h3 class="centraliza-titulo">Selecione a pessoa</h3>
    <h6 class="centraliza-intro">Visualize as pessoas cadastradas no canil e selecione quem está adotando neste momento</h6>
    <br><br> 
    <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive"> 
                        <form action="selecionarPessoa.php?page=0&id=<?php echo $id_animal?>" method="post"> 
                            ...
                            <table id="myTable" class="table table-striped table-bordered table-condensed" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr class="trData">
                                        ...
                                        <td>
                                            <a href="finalizaAdocao.php?id=<?php echo $id_animal?>&pessoa=<?php echo $dado["id_pessoa"];?>"> <button type="button"><span>Selecionar</span></button></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>        
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link" href="selecionarPessoa.php?page=0&id=<?php echo $id_animal?>">Anterior</a></li>
                                <?php for($i=0;$i<$num_total;$i++){
                                    $style = "";
                                    if($pagina_atual == $i)
                                        $style = "class=\"active\"";
                                ?>
                                <li class="active"> <a class="page-link" href="selecionarPessoa.php?page=<?php echo ($i * $itens_por_pagina); ?>&id=<?php echo $id_animal?>"><?php echo ($i + 1); ?></a> </li>
                                <?php }?>
                                <li class="page-item"><a class="page-link" href="selecionarPessoa.php?page=<?php echo $num_total-1; ?>&id=<?php echo $id_animal?>">Próxima</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
