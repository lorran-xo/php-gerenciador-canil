...
<div class="container">
    <h2>Informações Adicionais</h2>
        <form class="form">
            ...
            <input disabled class="field" name="raca" type="text" value="<?php echo $_SESSION['raca']; ?>" required>
                <?php echo "<span class='errortext'> $racaErro </span>"; ?>
            <label for="porte">Cor</label>
            <select disabled class="field" name="porte" required>
            ...
            <select disabled class="field" name="sexo" required>
            ...
            <input disabled class="field" name="idade" type="text" value="<?php echo $_SESSION['idade']; ?>" required>
                <?php echo "<span class='errortext'>$idadeErro</span>"; ?>
            
            <br/><br/><hr class="sidebar-divider my-0"><br/>
            <label for="sexo">Resgate feito por</label>
            <input disabled class="field" name="raca" type="text" value="<?php echo $_SESSION['raca']; ?>" required>
            ...
            <label for="sexo">Descrição</label>
            <input disabled class="field" name="raca" type="text" value="<?php echo $_SESSION['raca']; ?>" required>
            <div class="col-lg-12">            
                <br/><a href="index.php"> <button type="button" class="btn btn-success" data-toggle="modal">Voltar</button> </a>   
            </div>  
        </form>
